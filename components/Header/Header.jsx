...
export const Header = () => {
  return (
    <div className='bgImage h-[100vh]'>
      <div className='h-[100vh] relative md:static z-[1] place-content-center items-center mx-14 grid md:grid-cols-2 gap-6 tracking-wide'>
        ...
        <style jsx>{`
                .marker {
                    ...
                    border-image:url(${border.src});
                    border-image-slice: 20 0 20 0;
                }
